...
**/
var BrushColor = {
    BrushBlue:$$(go.Brush, { 0: "#ECF5FF", 1: "#46A3FF" }),
    BrushRed:$$(go.Brush, { 0: "#FFECEC", 1: "#FF9797" })
}
    //20170515 新增
    ...
    myDiagram.nodeTemplateMap.add("Zone2",//信息框//ouyang
        $$(go.Node, "Spot", nodeStyle(),
            ...
            $$(go.Shape, //形状:一个 圆角矩形 ，默认填充色为 白色，边框颜色为 红色
                {
                    fill: BrushColor.BrushRed,//"#E5B9B5",
                    stroke: "black",
                }/*,
                 new go.Binding("fill", "color")*/
            ),
    ...
    //横向连接区域
    myDiagram.nodeTemplateMap.add("HZoneD",//信息框//ouyang
        $$(go.Node, "Spot", nodeStyle(),
            { width: 100, height: 5, background: "#D8D8D8" },
            new go.Binding("width", "width").makeTwoWay(),
            new go.Binding("height", "height").makeTwoWay(),
            ...
            makePortX("BR", go.Spot.BottomRight, go.Spot.Right, true, true),
            //下边框链接点
            makePort("DZL1c", new go.Spot(0.05, 1), go.Spot.Top, true, true),
            makePort("DZL1", new go.Spot(0.1, 1), go.Spot.Top, true, true),
            makePort("DZL1a", new go.Spot(0.15, 1), go.Spot.Top, true, true),
            makePort("DZL2", new go.Spot(0.2, 1), go.Spot.Top, true, true),
            makePort("DZL2a", new go.Spot(0.25, 1), go.Spot.Top, true, true),
            makePort("DZL3", new go.Spot(0.3, 1), go.Spot.Top, true, true),
            makePort("DZL3a", new go.Spot(0.35, 1), go.Spot.Top, true, true),
            makePort("DZ14", new go.Spot(0.4, 1), go.Spot.Top, true, true),
            makePort("DZ14a", new go.Spot(0.45, 1), go.Spot.Top, true, true),
            makePort("DZL5", new go.Spot(0.5, 1), go.Spot.Top, true, true),
            makePort("DZL5a", new go.Spot(0.55, 1), go.Spot.Top, true, true),
            makePort("DZL6", new go.Spot(0.6, 1), go.Spot.Top, true, true),
            makePort("DZL6a", new go.Spot(0.65, 1), go.Spot.Top, true, true),
            makePort("DZL7", new go.Spot(0.7, 1), go.Spot.Top, true, true),
            makePort("DZL7a", new go.Spot(0.75, 1), go.Spot.Top, true, true),
            makePort("DZL8", new go.Spot(0.8, 1), go.Spot.Top, true, true),
            makePort("DZL8a", new go.Spot(0.85, 1), go.Spot.Top, true, true),
            makePort("DZL9", new go.Spot(0.9, 1), go.Spot.Top, true, true),
            makePort("DZL9a", new go.Spot(0.95, 1), go.Spot.Top, true, true),
            makePort("DZL10", new go.Spot(1, 1), go.Spot.Top, true, true)
